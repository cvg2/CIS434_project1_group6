...
class UserInput extends Component {
    ...
    render() {
        return (
            <div>
                <form className="card card-body col-md-8 mt-4" onSubmit={this.props.addTxn.bind(this.props.app, this.state)}>
                    ...
                    <input className="btn btn-primary btn-block btn-lg mt-3" type="submit" value="Add transaction" />
                </form>
            </div>
        );
    }
